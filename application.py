...
def clear():
    try:
        dynamodb = boto3.resource('dynamodb',
                            ...
                            aws_access_key_id="AKIAJDAQYYI5HP3BHA2Q",
                            aws_secret_access_key="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")
...
def create_db():   
    dynamodb = boto3.resource('dynamodb',
                        ...
                        aws_secret_access_key="9WNKaloqh0HbrBbkN90HikJnmA1ayRSCqfF06mpw")
    table_name = 'users'
    dynamodb_client = boto3.client('dynamodb',region_name='us-west-1',aws_access_key_id="AKIAJDAQYYI5HP3BHA2Q",aws_secret_access_key="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")
